...
import 'package:market/src/feature/user_profile/presntation/view/widgets/custom_section_title.dart';
...
class _CustomPersonalInformationState extends State<CustomPersonalInformation> {
  ...
  Widget build(BuildContext context) {
    ...
    // تحديد حالة الحفظ بناءً على أي من الحقول تم تعديلها
    bool savedata = !editname || !editemail || !editphone;
    ...
    return Column(
      children: [
        ...
        // المعلومات الشخصية
        CustomSectionTitle(
          savedata: savedata, // تمرير قيمة bool
